...
export default function PlayInvite() {
  ...
  return (
    <View style={styles.container}>
      <ScrollView
        ...
        bounces={false}
      >
        <Image style={styles.logo} source={require('../../assets/images/starterslogo.png')} />

        <View style={styles.title}>
          <Text style={styles.titleHeader}>Available Slates</Text>
          <Text style={styles.titleLabel}>Pick Your Matchup</Text>
        </View>
